...
#[derive(Clone)]
pub struct State<P: Package, V: Version, Priority: Ord + Clone> {
    root_package: P,
    root_version: V,
    ...
    /// Partial solution.
    /// TODO: remove pub.
    pub partial_solution: PartialSolution<P, V, Priority>,
...
impl<P: Package, V: Version, Priority: Ord + Clone> State<P, V, Priority> {
